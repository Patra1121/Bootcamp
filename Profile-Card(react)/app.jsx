...
function App() {
  const profilePic = "https://cdn-icons-png.flaticon.com/512/3135/3135715.png"; // Replace with your own image
  ...
  return (
    <div className="bg-white p-8 rounded-3xl shadow-xl max-w-sm text-center transform hover:scale-105 transition duration-500">
      ...
      />
      <h1 className="text-2xl font-bold mt-4 text-purple-800">Vivek Patra</h1>
